...
let externalExchangeOrders = new Schema(
  {
    ...
    calculatedPrice: { type: Number, required: true, default: 0 },
    price: { type: Number, required: true, default: 0 },
    calculatedUsdtPrice: { type: Number, required: true, default: 0 },
    ...
    updatedTotal: { type: Number, default: 0 },
    updatedUsdtTotal: { type: Number, default: 0 },
