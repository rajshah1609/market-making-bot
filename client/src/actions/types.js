...
export const GET_LIQUIDITY_DETAILS_START = "GET_LIQUIDITY_DETAILS_START";
export const GET_LIQUIDITY_DETAILS_SUCCESS = "GET_LIQUIDITY_DETAILS_SUCCESS";
export const GET_LIQUIDITY_DETAILS_FAIL = "GET_LIQUIDITY_BOT_FAIL";
export const GET_LIQUIDITY_DETAILS_FINISH = "GET_LIQUIDITY_BOT_FINISH";

export const VOLUMEBOT_UPDATE_START = "VOLUMEBOT_UPDATE_START";
export const VOLUMEBOT_UPDATE_SUCCESS = "VOLUMEBOT_UPDATE_SUCCESS";
export const VOLUMEBOT_UPDATE_FAIL = "VOLUMEBOT_UPDATE_FAIL";
export const VOLUMEBOT_UPDATE_FINISH = "VOLUMEBOT_UPDATE_FINISH";

export const VOLUMEBOT_GET_START = "VOLUMEBOT_GET_START";
export const VOLUMEBOT_GET_SUCCESS = "VOLUMEBOT_GET_SUCCESS";
export const VOLUMEBOT_GET_FAIL = "VOLUMEBOT_GET_FAIL";
export const VOLUMEBOT_GET_FINISH = "VOLUMEBOT_GET_FINISH";

export const VOLUMEBOT_FORCE_START_START = "VOLUMEBOT_FORCE_START_START";
export const VOLUMEBOT_FORCE_START_SUCCESS = "VOLUMEBOT_FORCE_START_SUCCESS";
export const VOLUMEBOT_FORCE_START_FAIL = "VOLUMEBOT_FORCE_START_FAIL";
export const VOLUMEBOT_FORCE_START_FINISH = "VOLUMEBOT_FORCE_START_FINISH";

export const VOLUMEBOT_DETAILS_START = "VOLUMEBOT_DETAILS_START";
export const VOLUMEBOT_DETAILS_SUCCESS = "VOLUMEBOT_DETAILS_SUCCESS";
export const VOLUMEBOT_DETAILS_FAIL = "VOLUMEBOT_DETAILS_FAIL";
export const VOLUMEBOT_DETAILS_FINISH = "VOLUMEBOT_DETAILS_FINISH";
